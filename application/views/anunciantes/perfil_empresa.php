                                ...
                                <div class="mb-4 text-center">
                                    <div class="wd-150 ht-150 mx-auto mb-3 position-relative">
                                        <div class="avatar-image wd-150 ht-150 border border-5 border-gray-3">
                                            <img src="<?= base_url('' . $cliente->imagen); ?>" alt="Avatar" class="img-fluid">
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        <a href="javascript:void(0);" class="fs-14 fw-bold d-block"><?php echo (!empty($aviso_error)) ? set_value('nombre') : $cliente->nombre; ?></a>
                                        <a href="javascript:void(0);" class="fs-12 fw-normal text-muted d-block"><?php echo (!empty($aviso_error)) ? set_value('email') : $cliente->email; ?></a>
                                    </div>
                                </div>
                                <ul class="list-unstyled mb-4">
                                    <li class="hstack justify-content-between mb-4">
                                        <span class="text-muted fw-medium hstack gap-3"><i class="feather-map-pin"></i>Población</span>
                                        <a href="javascript:void(0);" class="float-end"><?php echo (!empty($aviso_error)) ? set_value('poblacion') : $cliente->poblacion; ?></a>
                                    </li>
                                    <li class="hstack justify-content-between mb-4">
                                        <span class="text-muted fw-medium hstack gap-3"><i class="feather-phone"></i>Phone</span>
                                        <a href="javascript:void(0);" class="float-end"><?php echo (!empty($aviso_error)) ? set_value('telefono') : $cliente->telefono; ?></a>
                                    </li>
                                    <li class="hstack justify-content-between mb-0">
                                        <span class="text-muted fw-medium hstack gap-3"><i class="feather-mail"></i>Email</span>
                                        <a href="javascript:void(0);" class="float-end"><?php echo (!empty($aviso_error)) ? set_value('email') : $cliente->email; ?></a>
                                    </li>
                                </ul>
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <a href="https://www.facebook.com/theme_ocean" target="_blank" class="text-truncate-1-line">https://www.facebook.com/<span class="text-muted">theme_ocean</span></a>
                                </div>
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar-text bg-gray-100">
                                    ...
                                    <span class="mx-2 text-gray-300">/</span>
                                    <a href="https://www.twitter.com/theme_ocean" target="_blank" class="text-truncate-1-line">https://www.twitter.com/<span class="text-muted">theme_ocean</span></a>
                                </div>
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar-text bg-gray-100">
                                    ...
                                    <span class="mx-2 text-gray-300">/</span>
                                    <a href="https://www.github.com/theme_ocean" target="_blank" class="text-truncate-1-line">https://www.github.com/<span class="text-muted">theme_ocean</span></a>
                                </div>
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar-text bg-gray-100">
                                    ...
                                    <span class="mx-2 text-gray-300">/</span>
                                    <a href="https://www.linkedin.com/theme_ocean" target="_blank" class="text-truncate-1-line">https://www.linkedin.com/<span class="text-muted">theme_ocean</span></a>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="mx-2 text-gray-300">/</span>
                                    <a href="https://www.youtube.com/theme_ocean" target="_blank" class="text-truncate-1-line">https://www.youtube.com/<span class="text-muted">theme_ocean</span></a>
                                </div>
                            </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active p-4" id="overviewTab" role="tabpanel">
                                    ...
                                    <div class="profile-details mb-5">
                                        <div class="mb-4 d-flex align-items-center justify-content-between">
                                            <h5 class="fw-bold mb-0">Detalles de la cuenta:</h5>
                                            <a href="http://localhost:8000/obbak/anunciantes/perfilEmpresa1" class="btn btn-sm btn-light-brand">Editar cuenta:</a>
                                        </div>
                                        <div class="row g-0 mb-4">
                                            <div class="col-sm-6 text-muted">Nombre y apellidos:</div>
                                            <div class="col-sm-6 fw-semibold"><?php echo (!empty($aviso_error)) ? set_value('nombre') : $cliente->nombre; ?></div>
                                        </div>
                                        <div class="row g-0 mb-4">
