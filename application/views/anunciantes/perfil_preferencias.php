        ...
        <button class="boton waves-effect" type="submit">Guardar cambios</button>
                                    ...
                                    <div class="tab-pane" id="progress-bank-detail">
                                        <div class="row justify-content-center">
                                            <div class="mb-3">
											<form method="post" action="<?php echo base_url();?>anunciantes/perfilinversor1/1" class="form-horizontal">
...
<script>
    window.onload = function() {
        ...
        if (window.location.hash) {
            var targetId = window.location.hash; // Obtenemos el fragmento, como '#progress-company-document'
            
            // Encuentra la pestaña correspondiente y actívala
            var tabLink = document.querySelector('a[href="' + targetId + '"]');
            if (tabLink) {
                // Si existe un enlace de pestaña que corresponde al fragmento
                tabLink.click(); // Activa la pestaña correspondiente

                // Después de que la pestaña se activa, desplazamos a la sección
                setTimeout(function() {
                ...
                }, 500); // Esperamos un momento para asegurarnos de que la pestaña se activó
            }
        }
    };
</script>
