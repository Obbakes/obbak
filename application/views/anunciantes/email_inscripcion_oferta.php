			...
			<table cellspacing="0" cellpadding="0" border="0" style="border: 1px solid lightgray; width: 100%; border-spacing: 0;
				...
				<tbody><tr>
					<td width="100%" style="padding: 15px 23px 5px 23px; text-align: center;" bgcolor="white">
						<span style="">
							El anunciante <b><?php echo $anunciante; ?></b> se ha inscrito a la oferta <b><?php echo $titulo; ?></b>
						</span>
					</td>
				</tr>
				<tr>
					<td colspan="" rowspan="" headers="">
						<span>
							<ul style="padding: 0; max-width: 100%;text-align: justify;width: 90%;margin: auto;list-style: none;">
								<li style="padding: 5px 0px;"><img src="<?php echo base_url() . $imagen; ?> " alt=""></li>
								<li style="padding: 5px 0px;">Titulo Oferta: <?php echo $titulo; ?></li>
								<li style="padding: 5px 0px;">Fin de la oferta: <?php echo $fecha_fin_pub; ?></li>
								<li style="padding: 5px 0px;">Descripción de la oferta: <?php echo $descripcion_medio; ?></li>
							</ul>
						</span>
					</td>
				</tr>
