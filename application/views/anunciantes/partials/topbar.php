                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            ...
                            <div class="notifications-item">
                                <img src="https://app.obbak.es/assets/images/avatar/3.png" alt="" class="rounded me-3 border" />
                                <div class="notifications-desc">
                            ...
                            <div class="notifications-item">
                                <img src="https://app.obbak.es/assets/images/avatar/4.png" alt="" class="rounded me-3 border" />
                                <div class="notifications-desc">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-dark mb-0"><?php echo (!empty($aviso_error)) ? set_value('nick') : $cliente->nick; ?><span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                        <span class="fs-12 fw-medium text-muted"><?php echo (!empty($aviso_error)) ? set_value('email') : $cliente->email; ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="dropdown">
