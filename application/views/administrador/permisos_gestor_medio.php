...
<script type="application/javascript">
	...
	function realizarCambios(){
		var cambios = '';
                ...
                $('#cambiosEnproceso').css('display', 'block');
...
<h1>
	Permisos en Medios de <?php echo $gestor->nombre; ?>
</h1>
<div>
	<div class="generalEdit">
		<form accept-charset="utf-8" method="post" action="<?php echo base_url() . 'administrador/permisosGestorMedio/' . $gestor->id_gestor . '/1'; ?>"
...
?>
			...
			<div class="filtro_ofertas" style="width: 385px; padding-top: 10px; margin: auto;">
				...
				<div class="contact_form_area">
					<a href="<?php echo base_url().'administrador/permisosGestorMedio/' . $gestor->id_gestor . '/0/1'; ?>">
...
<?php
			if(is_numeric($permiso->estado) && $permiso->estado == 0){
?>
...
?>
			...
			<a id="cambiosEnproceso" style="text-decoration: none; display: none; width: 200px; float: right;">
				<div class="contact_form_area" style="width: 200px;">
					<input type="button" class="classname" value="En proceso..." />
				</div>
			</a>
			<div class="paginacion">
				<?php echo $paginacion; ?>&nbsp;&nbsp;<a href="<?php echo base_url().'administrador/permisosGestorMedio/'.$gestor->id_gestor.'/2/1/400'?>">Mostrar Todos</a>
			</div>
		</div>
		<form id="form_permisos" action="<?php echo base_url() .'administrador/cambiarPermisosGestorMedios/' . $gestor->id_gestor; ?>"
