	...
	<body>
		<div align="center">
			<h2 style="max-width: 694px; text-align: center; font-weight: normal; font-size: 26px; color: #002684; width: 100%; 
				...
				<br />
				<?php echo ($tipo == 'agencia') ? 'Nueva agencia registrada' : 'Nuevo anunciante registrado'; ?>
			</h2>
			<table cellspacing="0" cellpadding="0" border="0" style="border: 1px solid lightgray; width: 100%; border-spacing: 0; 
				...
				<tr>
					<td width="100%" style="font-weight: bold; padding: 5px 23px 5px 23px; text-align: center;" bgcolor="white">
						<span style="">
                                                    <a href="<?php echo base_url() . 'inicio/send_permisos_medios/' . $id; ?>" target="_blank" style="text-decoration: none;">Enviar Emails a Medios para pasar Filtro</a>
						</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td width="100%" style="text-align: right; padding: 5px 15px 15px 0px;" bgcolor="white">
						<a href="<?php echo base_url() . 'administrador/' . (($tipo == 'agencia') ? 'editarAgencia/' : 'editarAnunciante/') . $id; ?>" target="_blank" style="text-decoration: none;">
